...
const updateById = async (req, res) => {
	const { id } = req.params;
	const { first_name, last_name, age, department, min_salary_expectation, max_salary_expectation } = req.body;
	try {
		if (!req.params.id) {
		...
		if (max_salary_expectation) data.max_salary_expectation = max_salary_expectation;
		await data.save();
